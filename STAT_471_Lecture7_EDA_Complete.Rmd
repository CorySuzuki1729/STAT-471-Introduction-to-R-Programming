...
bike_data = read.csv("C:/Users/coryg/Downloads/bike_buyers.csv", header=TRUE, na.strings ='')
...
ggplot(data = bike_data) +
  geom_histogram(mapping = aes(x = Cars))
...
ggplot(data = bike_data, aes(x = Gender, y = Age)) +
  geom_point()
```
...
```{r}
ggplot(data = bike_data, mapping = aes(x = Age, y = Income)) +
  geom_boxplot()
```
