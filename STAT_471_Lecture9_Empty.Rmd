...
sample2 = c(335, 339, 332, 331, 334, 339, 334, 316, 315, 331, 317, 330, 325)

t.test(x = sample1, y = sample2, sigma.x = 3, sigma.y = 8, alternative = "two.sided")
```
Earlier, we saw a one sample Z test. This can also be extended to two samples similar to how we carried out the T test.

```{r}
res2 = z.test(x = sample1, y = sample2, sigma.x = 3, sigma.y = 8, alternative = "two.sided")
res2
```
...
data = matrix(c(30, 10, 20, 40), nrow = 2, byrow = TRUE,
              dimnames = list(Gender = c("Male", "Female"), Preference = c("Product A","Product B")))
chisq.test(data)
