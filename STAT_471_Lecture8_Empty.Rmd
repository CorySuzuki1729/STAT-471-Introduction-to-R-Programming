...
```{r}
connect4 = dbConnect(RSQLite::SQLite(),
                     dbname = "example_database.db")
```
...
```{r}
dbExecute(connect4, "
          Insert Into Students (Firstname, LastName, Age, GPA) Values ('Daniel', 'Larusso', 30, 3.5);")

dbExecute(connect4, "
          Insert Into Students (Firstname, LastName, Age, GPA) Values ('Bryan', 'Mercado', 27, 4.00);")

dbExecute(connect4, "
          Insert Into Students
          (Firstname, LastName, Age, GPA) Values ('Cory', 'Suzuki', 30, 3.67);")
...
dbExecute(connect4, "
          Update Students
          Set IDNumber = Case
          When IDNumber = 1 Then 025748
          When IDNumber = 2 Then 078357
          When IDNumber = 3 Then 510574
          Else IDNumber
          End
          Where IDNumber In (1,2,3);")
